...
/// to retrieve historical prices from Yahoo Finance from a certain start date
///
...
/// <summary>This function simply curries downloadHistFromDate with the optional
/// startDate set to None</summary>
/// <param name="stockCode">Reuters code of the stock</param>
/// <returns>CsvProvider object with the date, open, high, low, close, volume
/// and adjusted close prices in each row</returns>
///
